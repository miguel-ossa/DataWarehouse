create or replace procedure CargarFact_Ventas is
begin

INSERT INTO destino.fact_ventas (id_mes, id_pais, id_provincia, id_tienda, id_familia, id_tejido, id_modelo, unidades, pvp_total)
   SELECT 
          omes.id_mes, 
          opai.id_pais, 
          opro.id_provincia,
